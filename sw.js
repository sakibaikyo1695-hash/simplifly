// SIMPLIFLY - Civil Air Navigation System
// Service Worker: Offline support for app shell + map tiles (normal + satellite)
// Tiles pre-cached before flight remain available offline.

const VERSION = 'simplifly-v1';
...
const MAX_SATELLITE_ENTRIES = 3000;
